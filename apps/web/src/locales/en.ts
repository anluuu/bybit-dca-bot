...
export const en: Translations = {
  ...
  copy: {
    page: {
      title: "Copy Trader",
      subtitle: "Live ingestion + dry-run executor for Mack signals.",
      sections: {
        trades: "Trades",
        signals: "Signals",
        config: "Config",
    ...
    systemState: {
      ...
      killedAt: "Killed at",
      confirmReset: "Re-enable bot? This clears the kill switch.",
      promptKillReason: "Manual kill reason:",
      defaultKillReason: "manual",
    },
    stats: {
